...
public class GuaraController implements RobotController
{
   ...
   public void doControl()
   {
      do
      {
         ...
         {
            pawXYZ = waveGait.footPath(pawNumber, setPointCounter, pawXYZ[pawNumber][0], pawXYZ[pawNumber][1], pawXYZ[pawNumber][2], pawState[i]);
            theta = kinematics.inverseKinematics(pawXYZ, pawNumber);

            switch (pawNumber)
            {
            case 0:
               tau_abdHip0.set(k4 * (theta[0] - q_abdHip0.getValueAsDouble()) + kd4 * (0 - qd_abdHip0.getValueAsDouble()));
               ...
               break;
            case 1:
               tau_abdHip1.set(k4 * (theta[0] - q_abdHip1.getValueAsDouble()) + kd4 * (0 - qd_abdHip1.getValueAsDouble()));
               ...
               break;
            case 2:
               tau_abdHip2.set(k4 * (theta[0] - q_abdHip2.getValueAsDouble()) + kd4 * (0 - qd_abdHip2.getValueAsDouble()));
               ...
               break;
            case 3:
               tau_abdHip3.set(k4 * (theta[0] - q_abdHip3.getValueAsDouble()) + kd4 * (0 - qd_abdHip3.getValueAsDouble()));
