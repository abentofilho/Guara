...
/*      ((PinJoint) flexAnkle0).setInitialState(-Math.PI/2, 0);
      ((PinJoint) flexAnkle1).setInitialState(-Math.PI/2, 0);
      ((PinJoint) flexAnkle2).setInitialState(-Math.PI/2, 0);
      ((PinJoint) flexAnkle3).setInitialState(-Math.PI/2, 0);
*/
